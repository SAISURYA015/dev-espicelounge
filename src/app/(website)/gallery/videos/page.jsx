...
const Gallery = () => {
  ...
  // video
  const handleVideoPrev = (e) => {
    e.stopPropagation();
    if (data.videos.length === 0) return;

    const newIndex =
      currentVideoIndex === 0 ? data.videos.length - 1 : currentVideoIndex - 1;
  ...
  const handleVideoNext = (e) => {
    e.stopPropagation();
    if (data.videos.length === 0) return;

    const newIndex =
      currentVideoIndex === data.videos.length - 1 ? 0 : currentVideoIndex + 1;
                      ...
                      <video
                        ...
                        onClick={(e) => {
                          ...
                          setCurrentVideoIndex(
                            data.videos.findIndex((vid) => vid.id === video.id)
                          );
